...
describe("buildMenuReadModel", () => {
  it("exposes only public-safe fields and builds WhatsApp URL", () => {
    const model = buildMenuReadModel({
      settings: { businessName: "Taco Loco", whatsappPhone: "+5491122334455", whatsappMessage: "Hola Taco Loco" , currency: "ARS", acceptingOrders: true, statusMessage: null, weeklySchedule: [], deliveryEnabled: false, deliveryFeeAmount: 0 },
