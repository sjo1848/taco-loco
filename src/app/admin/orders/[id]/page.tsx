...
type OrderDetail = { id: string; orderNumber: number; status: "RECEIVED" | "CONFIRMED" | "IN_PREPARATION" | "READY" | "DELIVERED" | "CANCELLED"; source: "WHATSAPP" | "PUBLIC_MENU"; customerName: string | null; customerPhone: string | null; fulfillment: "PICKUP" | "DINE_IN" | "DELIVERY"; verificationStatus: string; paymentStatus: string; deliveryAddress: string | null; deliveryReference: string | null; deliveryFeeAmount: number; transferHolderName: string | null; tableLabel: string | null; totalAmount: number; subtotalAmount: number; adjustmentAmount: number; notes: string | null; cancellationReason: string | null; createdAt: Date; createdBy: { email: string } | null; lines: OrderLine[]; events: OrderEvent[] };
