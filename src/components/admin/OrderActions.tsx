...
export function OrderActions({ orderId, transitions, fulfillment }: { orderId: string; transitions: OrderStatus[]; fulfillment: "PICKUP" | "DINE_IN" | "DELIVERY" }) {
