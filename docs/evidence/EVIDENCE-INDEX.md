...
- Order-flow Stages B–D: PARTIAL — rework candidate `c2c9330d587cb9f16aab629ea0596d131364917b`; strict delivery gate, checkout, exception actions, D1 bindings, queue filters and tests pass; independent assurance and remote staging remain pending. Evidence: `docs/evidence/TL-TC-ORDER-FLOW-STAGES-BCD-c2c9330.md`.
