...
- Validation: PARTIAL — local adaptation is PROVEN; remote provider journey is complete but final-candidate independent assurance is pending.
...
- Remote D1 staging contract: REWORK_PENDING_ASSURANCE — `docs/contracts/TL-CF-D1-REMOTE-STAGING-01.md`; exact final candidate `6eccc3aa81d351fc3e9e8ee718f781a77a9b48e3`.
- Remote staging evidence: PROVISIONAL — `docs/evidence/TL-CF-D1-REMOTE-STAGING-6eccc3a.md`; Worker/D1/Static Assets journey completed, pending fresh independent assurance.
