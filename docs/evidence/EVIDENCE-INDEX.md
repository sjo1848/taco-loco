...
- Validation: PARTIAL — local adaptation and independent assurance are PROVEN; remote provider validation is active and not yet proven.
...
- Remote D1 staging contract: ACTIVE — `docs/contracts/TL-CF-D1-REMOTE-STAGING-01.md`; exact remote candidate `4007a5810c998a7c4478dfb4b054c9c612860a1a`.
